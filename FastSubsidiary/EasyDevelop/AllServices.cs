...
namespace Extensions.EasyDevelop
{
    ...
    {
        public static void InitAllServices(this IApplicationBuilder app, IServiceCollection services)
        {
            if (app == null) throw new ArgumentNullException(nameof(app));

            List<Type> tsDIAutofac = new();
            tsDIAutofac.AddRange(Assembly.LoadFrom(Path.Combine(AppContext.BaseDirectory, "SugarClient.dll")).GetTypes().ToList());  //加入仓储层的所有类型
            ...
            app.Map("/allservices", builder => builder.Run(async context =>
            {
                ...
                await context.Response.WriteAsync($"<h3>所有服务{services.Count + tsDIAutofac.Count}个</h3><table class='table2_1'><thead><tr><th>类型</th><th>生命周期</th><th>Instance</th></tr></thead><tbody>");
                ...
                await context.Response.WriteAsync("<tr><td colspan='3'>仓储</td></tr>");
